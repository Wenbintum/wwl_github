...
# all_feature_list = ['atomic_number', 
#             'atomic_radius', 
#             #'atomic_radius_rahm',
#             'atomic_volume', 
#             #'atomic_weight', 
...
# import itertools
# feature_combina = list(itertools.combinations(all_feature_list,8))
# import random
# train_RMSEs,train_MAEs,test_RMSEs,test_MAEs =[],[],[],[]
# for  feature_list in random.sample(feature_combina,50):
# feature_list = list(feature_list)


#feature_list = ['atomic_number', 'vdw_radius','electron_affinity','en_pauling' , 'dband_center_bulk', 'dband_width_bulk']#,'Local_parameter']
